...
```
Download failed after 3 attempts. Last error: curl: (6) Could not resolve host: D.mrpack
Warning: Problem : timeout. Will retry in 5 seconds. 3 retries left.
#=#=#                                                                          curl: (6) Could not resolve host: D.mrpack
